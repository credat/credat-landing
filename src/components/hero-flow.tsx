...
export function HeroFlow() {
  ...
  return (
    ...
    >
      <defs>
        {/* Gradient for paths */}
        <linearGradient id="pathGradIH" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#2563EB" stopOpacity="0.6" />
          <stop offset="100%" stopColor="#7C3AED" stopOpacity="0.6" />
        </linearGradient>
        <linearGradient id="pathGradHV" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#7C3AED" stopOpacity="0.6" />
          <stop offset="100%" stopColor="#059669" stopOpacity="0.6" />
        </linearGradient>
        <linearGradient id="pathGradIV" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path
        ...
        strokeDashoffset="0"
      />
      {/* Issuer → Verifier (trust line, dashed lighter) */}
      <path
        className="flow-path"
        d="M 165 80 Q 260 50 350 105"
        stroke="url(#pathGradIV)"
        strokeWidth="1.5"
        strokeDasharray="4 6"
        fill="none"
        pathLength="300"
      ...
      {/* ── Flowing dots (animated via CSS) ──────────── */}
      {/* Issuer → Holder dots */}
      <circle className="flow-dot flow-dot-ih" r="3" fill="#2563EB">
        <animateMotion
          dur="3s"
      ...
      <circle className="flow-dot flow-dot-ih" r="2.5" fill="#7C3AED" opacity="0.7">
        <animateMotion
          dur="3s"
          repeatCount="indefinite"
          begin="1s"
      ...
      {/* Holder → Verifier dots */}
      <circle className="flow-dot flow-dot-hv" r="3" fill="#059669">
        <animateMotion
          dur="3.5s"
          repeatCount="indefinite"
          begin="0.5s"
      ...
      <circle className="flow-dot flow-dot-hv" r="2.5" fill="#7C3AED" opacity="0.7">
        <animateMotion
          dur="3.5s"
          repeatCount="indefinite"
          begin="2s"
      ...
      {/* ── Credential card (between Issuer and Holder) ─ */}
      <g className="flow-card" filter="url(#cardShadow)">
        ...
        <rect x="68" y="163" width="40" height="4" rx="2" fill="#2563EB" />
        <rect x="68" y="173" width="60" height="3" rx="1.5" fill="#D1D5DB" />
        <rect x="68" y="180" width="45" height="3" rx="1.5" fill="#D1D5DB" />
        <rect x="68" y="195" width="24" height="16" rx="3" fill="#DBEAFE" />
        <text x="80" y="206" fontSize="7" fontWeight="600" fill="#2563EB" textAnchor="middle">VC</text>
        <rect x="96" y="195" width="52" height="3" rx="1.5" fill="#E5E7EB" />
        <rect x="96" y="202" width="38" height="3" rx="1.5" fill="#E5E7EB" />
      </g>
      ...
      <g className="flow-node" filter="url(#nodeGlow)">
        ...
        <g transform="translate(133, 68)">
          <rect x="3" y="4" width="18" height="16" rx="1" fill="none" stroke="#2563EB" strokeWidth="1.5" />
          <rect x="7" y="8" width="3" height="3" rx="0.5" fill="#2563EB" opacity="0.6" />
          <rect x="14" y="8" width="3" height="3" rx="0.5" fill="#2563EB" opacity="0.6" />
          <rect x="7" y="13" width="3" height="3" rx="0.5" fill="#2563EB" opacity="0.6" />
          <rect x="14" y="13" width="3" height="3" rx="0.5" fill="#2563EB" opacity="0.6" />
      ...
      <g className="flow-node" filter="url(#nodeGlow)">
        ...
        {/* Person/wallet icon */}
        <g transform="translate(188, 273)">
          <circle cx="12" cy="7" r="5" fill="none" stroke="#7C3AED" strokeWidth="1.5" />
